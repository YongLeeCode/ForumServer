...
public class UserController {
    ...
    public ResponseEntity<StandardResponse<String>> createUser(@RequestBody UserDto req) {
    ...
    public ResponseEntity<StandardResponse<String>> updateUser(@RequestParam Long id, @RequestBody UpdateUserRequest req) {
